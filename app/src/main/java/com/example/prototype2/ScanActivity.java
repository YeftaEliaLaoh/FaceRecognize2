...
import com.example.prototype2.preference.SettingsActivity.LaunchSource;
    ...
    private void bindAnalysisUseCase() {
        ...
        analysisUseCase.setAnalyzer(
                ...
                imageProxy -> {
                    ...
                    try {
                        imageProcessor.processImageProxy(imageProxy, graphicOverlay, appDatabases, getIntent().getStringExtra("page"));
